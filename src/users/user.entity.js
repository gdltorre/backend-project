...
var task_entity_1 = require("../tasks/task.entity");
var User = function () {
    ...
    var User = _classThis = /** @class */ (function () {
        function User_1() {
            ...
            this.tasks = (__runInitializers(this, _email_extraInitializers), __runInitializers(this, _tasks_initializers, void 0));
    ...
    (function () {
        ...
        _tasks_decorators = [(0, typeorm_1.OneToMany)(function () { return task_entity_1.Task; }, function (task) { return task.user; })];
